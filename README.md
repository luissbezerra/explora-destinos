# explora-destinos
Projeto web responsivo desenvolvido com HTML5, CSS3 e JavaScript. Apresenta um guia interativo de destinos turísticos com filtro de busca em tempo real, expansão de cards ao clicar e alternador de tema claro/escuro.
# 🗺️ ExploraDestinos - Guia de Viagens

Projeto desenvolvido como atividade individual para a disciplina de Coding: Mobile.
